...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ asset('favicon_package_v0.16/favicon.ico') }}">
        <!-- Fonts -->
        <link href="//fonts.googleapis.com/css?family=Poppins:200,300,400,600,700,800" rel="stylesheet" />
